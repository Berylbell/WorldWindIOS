/*
 ...
 @version $Id: WWWmsUrlBuilder.m 1390 2013-05-31 22:15:50Z dcollins $
 */
...
//    double zoomLvL = fabs(180/ ([s maxLongitude]- [s minLongitude]))-1;
//    double yLoc = fabs([s maxLatitude] * (zoomLvL +1)/180)-1;
//    double xLoc= fabs([s maxLongitude] * (zoomLvL +1)/180)-1;
