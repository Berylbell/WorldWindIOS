/*
 ...
 @version $Id: WWRetrieverToFile.h 1374 2013-05-30 15:48:16Z tgaskins $
 */

#import <Foundation/Foundation.h>

/**
* Provides retrieval and caching of resources to a file. This class is typically used to retrieve image and elevation
* resources from the internet and save them to the local World Wind file system cache.
 *
...
*/
@interface WWRetrieverToFile : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate>
{
...
*/
- (WWRetrieverToFile*) initWithUrl:(NSURL*)url filePath:(NSString*)filePath object:(id)object timeout:(NSTimeInterval)timeout;
